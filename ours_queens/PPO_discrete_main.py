...
if __name__ == '__main__':
    ...
    parser.add_argument("--seed", type=int, default=0, help="How many steps before the epsilon decays to the minimum")
    ...
    main(args, env_name=args.env_name, number=1, seed=args.seed)
