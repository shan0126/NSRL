...
def formula_sudoku4r():
    foldername = "SDDCircuits/sudoku4r/b1/"
    ...
    var_count = 64  # 4x4 grid, each cell has 4 possible values
    ...
    with open(foldername + "sdd_sudoku4.dot", "w") as out:
        print(alpha.dot(), file=out)
    with open(foldername + "vtree_sudoku4.dot", "w") as out:
