...
def formula_nqueens8():
    foldername = "SDDCircuits/nqueens8/"
    ...
    with open(foldername + "nqueens8_sdd.dot", "w") as out:
        print(alpha.dot(), file=out)
    with open(foldername + "nqueens8_vtree.dot", "w") as out:
       print(vtree.dot(), file=out)

    print("saving as sdd ...")
    alpha.save((foldername + "nqueens8.sdd").encode())
    print("saving as vtree ...")
    vtree.save((foldername + "nqueens8.vtree").encode())
