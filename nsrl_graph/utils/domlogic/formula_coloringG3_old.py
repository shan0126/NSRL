...
def formula_coloringG3():
    foldername = "SDDCircuits/coloringG3/"
    ...
    with open(foldername + "coloringG3_sdd.dot", "w") as out:
        print(alpha.dot(), file=out)
    with open(foldername + "coloringG3_vtree.dot", "w") as out:
        print(vtree.dot(), file=out)

    print("saving as sdd ...")
    alpha.save((foldername + "coloringG3.sdd").encode())
    print("saving as vtree ...")
    vtree.save((foldername + "coloringG3.vtree").encode())
