...
def formula_nqueens6():
    foldername = "SDDCircuits/nqueens6/"
    ...
    with open(foldername + "nqueens6_sdd.dot", "w") as out:
        print(alpha.dot(), file=out)
    with open(foldername + "nqueens6_vtree.dot", "w") as out:
       print(vtree.dot(), file=out)

    print("saving as sdd ...")
    alpha.save((foldername + "nqueens6.sdd").encode())
    print("saving as vtree ...")
    vtree.save((foldername + "nqueens6.vtree").encode())
